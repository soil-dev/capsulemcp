...
```sh
claude mcp add capsule --env CAPSULE_API_TOKEN=<your token> -- npx -y github:arapov/capsulemcp#v0.5.1
```
...
claude mcp add capsule -- npx -y github:arapov/capsulemcp#v0.5.1
```
...
1. **Bump the version in your config**: change `#v0.5.1` to a newer tag and restart.
