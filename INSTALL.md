...
```sh
claude mcp add capsule --env CAPSULE_API_TOKEN=<your token> -- npx -y github:arapov/capsulemcp#v0.4.0
```
...
claude mcp add capsule -- npx -y github:arapov/capsulemcp#v0.4.0
```
...
1. **Bump the version in your config**: change `#v0.4.0` to a newer tag and restart.
