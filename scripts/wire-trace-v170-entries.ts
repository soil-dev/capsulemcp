 ...
 *
 * Pattern mirrors scripts/wire-trace-v164.ts and -v165.ts: ZZZ-V170-ENT-*
 ...
 * with:
 *
 *   CAPSULE_API_TOKEN=<write-scoped> npx tsx scripts/wire-trace-v170-entries.ts
 */
...
async function main() {
  const tag = `ZZZ-V170-ENT-${Date.now()}`;
